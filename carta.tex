...
% personal data
\name{Rodrigo}{Ferreira de Brito}
\title{Carta de Apresentação}                               % optional, remove / comment the line if not wanted
\address{Belo Horizonte, MG}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
\phone[mobile]{(31) 9 8377-7950}                   % optional, remove / comment the line if not wanted
%\phone[fixed]{(31) 3672-6290}                    % optional, remove / comment the line if not wanted
%\phone[fax]{+3~(456)~789~012}                      % optional, remove / comment the line if not wanted
\email{contato@rodrigobrito.net}                               % optional, remove / comment the line if not wanted
%\homepage{www.rodrigobrito.net}                         % optional, remove / comment the line if not wanted
